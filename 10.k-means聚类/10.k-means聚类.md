...
![K-Means 术语图](https://i.imgur.com/QvUcjKi.jpg)
...
参考运行结果如下:  
![K-Means 运行结果1](https://i.imgur.com/7wUD7PA.jpg)
...
局部最小值的的情况如下:  
![K-Means 局部最小值1](https://i.imgur.com/hpnRqPi.jpg)
...
运行参考结果如下:  
![二分 K-Means 运行结果1](https://i.imgur.com/fcSxGqr.jpg)

***
* **版权声明：参考信息来源于 [ApacheCN](http://www.apachecn.org/)**