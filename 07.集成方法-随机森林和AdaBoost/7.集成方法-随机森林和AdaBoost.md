...
![数据重抽样](https://i.imgur.com/h5X0CBN.png)
...
![特征重抽样](https://i.imgur.com/PbSjsmP.png)
...
![AdaBoost 工作原理](https://i.imgur.com/rURWYuw.jpg "AdaBoost 工作原理")
...
![AdaBoost代码流程图](https://i.imgur.com/VBSEUJV.jpg "AdaBoost代码流程图")
...
![过拟合](https://i.imgur.com/s4Q4iX0.png)

* 通俗来说：就是把一些噪音数据也拟合进去的，如下图。

![过拟合](https://i.imgur.com/nMdpPVW.jpg)
...
![AdaBoost算法权重计算公式](https://i.imgur.com/8AyWCyJ.jpg "AdaBoost算法权重计算公式")
...
![ROC曲线](https://i.imgur.com/ofzKqqO.png)
...
![代价函数](https://i.imgur.com/PGrZgaM.png)
