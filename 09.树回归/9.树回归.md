...
![基于 CART 算法构建回归树的简单数据集](https://i.imgur.com/lPiyl7z.png)  

用于测试回归树的分段常数数据集  
![用于测试回归树的分段常数数据集](https://i.imgur.com/mSXQsZw.png)  
...
![分段线性数据](https://i.imgur.com/ZhYKsIA.png)
...
![模型树运行结果](https://i.imgur.com/0JOk0pG.png)
...
![骑自行车速度和智商之间的关系](https://i.imgur.com/MUxAihG.png)
...
![GUI示例图](https://i.imgur.com/gLU0Gqy.png")
...
![取得更好预测效果的GUI示例图](https://i.imgur.com/L1gAFfe.png "取得更好预测效果的GUI示例图")
